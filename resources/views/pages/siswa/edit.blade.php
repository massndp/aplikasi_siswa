    ...
    <h3>Edit Data Siswa</h3>
            <form action="{{route('siswa.update', $data_siswa->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form group">
                    ...
                    value="{{$data_siswa->nama_lengkap}}" required>
                ...
                <div class="form group">
                    ...
                    value="{{$data_siswa->ttl}}" required>
                    @error('ttl') <div class="text-muted">{{$message}}</div> @enderror
                </div>
                <div class="form group">
                    <label for="jenis_kelamin">Jenis Kelamin</label>
                    <select name="jenis_kelamin" class="form-control" required>
                        <option value="{{$data_siswa->jenis_kelamin}}">Pilih Jenis Kelamin</option>
                ...
                <div class="form group">
                    ...
                    value="{{$data_siswa->alamat}}" required>
